...
if (firstKeywords.includes(document.querySelector('.search-input').value)) {
...
if (!document.querySelector('.search-input').value) {
  document.querySelector('.search-result').innerHTML = 'Invalid search.';
  document.querySelector('.search-result').classList.add('Result-header-error')
} else if (!firstKeywords.includes(document.querySelector('.search-input').value)) {
  document.querySelector('.search-result').innerHTML = 'No recipe found.';
  document.querySelector('.search-result').classList.add('Result-header-error')
}

const RecipeObject2 = recipesContainer1[1];
const Keywords2 = RecipeObject2.keywords
if (Keywords2.includes(document.querySelector('.search-input').value)) {
  document.querySelector('.search-result').innerHTML =
  `
  <p class="Result-header">Results of Search.</p>
  <div class="card searchable" id="recipe1" class="recipe1">
...
if (Keywords3.includes(document.querySelector('.search-input').value)) {
  document.querySelector('.search-result').innerHTML =
  `
  <p class="Result-header">Results of Search.</p>
  <div class="card searchable" id="recipe1" class="recipe1">
...
if (Keywords4.includes(document.querySelector('.search-input').value)) {
  document.querySelector('.search-result').innerHTML =
  `
  <p class="Result-header">Results of Search.</p>
  <div class="card searchable" id="recipe1" class="recipe1">
